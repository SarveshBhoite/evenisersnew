      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
              ...
              {orders.map((order: any) => (
                <tr key={order._id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm font-medium">{order.shippingAddress?.firstName} {order.shippingAddress?.lastName}</div>
          ...
          {orders.length === 0 && !loading && (
            <div className="p-20 text-center text-muted-foreground">No orders found.</div>
          )}
        </div>
      </div>
    </div>
...
// 2. The Detailed Modal Component
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-serif text-2xl border-b pb-4">
            Order Details <span className="text-muted-foreground text-sm font-sans ml-2">#{order._id}</span>
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="grid md:grid-cols-2 gap-8 py-6">
          ...
          <div className="space-y-4">
            <h3 className="font-bold flex items-center gap-2"><User className="w-4 h-4" /> Customer Info</h3>
          ...
          {/* Logistics Info */}
          <div className="space-y-4">
            <h3 className="font-bold flex items-center gap-2"><Calendar className="w-4 h-4" /> Order Info</h3>
            <div className="text-sm bg-gray-50 p-4 rounded-lg space-y-1">
        ...
        {/* Items List */}
        <div className="space-y-4">
          <h3 className="font-bold flex items-center gap-2"><Package className="w-4 h-4" /> Ordered Items</h3>
