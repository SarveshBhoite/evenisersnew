...
import { Loader2, ArrowLeft, Mail, Sparkles, ShieldCheck, CheckCircle2, ArrowRight, KeyRound, Star, Send } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 bg-white border border-zinc-200 shadow-2xl shadow-zinc-200/50 overflow-hidden">
            ...
            <div className="p-6 md:p-10 lg:p-12 bg-gradient-to-b from-white to-[#FDFCF8] flex flex-col justify-center">
              ...
              {/* Back Button */}
              <Link href="/login" className="flex items-center gap-2 text-sm text-zinc-400 hover:text-[#D4AF37] mb-8 transition-colors group">
                <div className="w-8 h-8 rounded-full border border-zinc-200 group-hover:border-[#D4AF37] flex items-center justify-center transition-colors">
              ...
              <div className="md:hidden text-center mb-8">
                <div className="flex items-center justify-center gap-2 mb-3">
                  ...
                  <span className="text-[#B8860B] text-xs font-bold uppercase tracking-[0.2em]">Recovery</span>
                </div>
                <h1 className="font-serif text-3xl font-bold text-zinc-900">Forgot Password?</h1>
              </div>
              ...
              {sent ? (
                ...
                <div className="text-center py-6">
                  <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-green-100 to-green-50 flex items-center justify-center border border-green-200">
                  ...
                  <p className="text-sm font-bold text-zinc-900 bg-zinc-100 inline-block px-4 py-2 mb-6">{email}</p>
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-2 border-zinc-200 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all"
                  >
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  {/* Icon */}
                  <div className="w-16 h-16 mx-auto md:mx-0 rounded-2xl bg-gradient-to-br from-[#D4AF37]/10 to-[#B8860B]/5 flex items-center justify-center border border-[#D4AF37]/20 mb-2">
