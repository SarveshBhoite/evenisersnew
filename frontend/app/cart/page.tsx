...
export default function CartPage() {
  ...
  // Helper to handle date/time/message changes
  const handleDetailChange = (productId: string, field: string, value: string) => {
      updateItemDetails(productId, { [field]: value });
  };
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            {cartItems.map((item) => {
              ...
              // Calculate prices locally for display
              const discount = product.discount || 0;
              const price = product.price;
              const finalPrice = discount > 0 ? price - (price * discount / 100) : price;

              return (
                <div key={product._id} className="bg-white rounded-[2rem] p-6 shadow-sm border border-zinc-100 transition-all hover:shadow-md group">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="space-y-1">
                              ...
                              <Input 
                                  ...
                                  onChange={(e) => handleDetailChange(product._id, 'eventDate', e.target.value)}
                              />
                          </div>
                          ...
                          <div className="space-y-1">
                              ...
                              <select 
                                  ...
                                  value={item.timeSlot || ""}
                                  onChange={(e) => handleDetailChange(product._id, 'timeSlot', e.target.value)}
                              >
                      ...
                      <div className="space-y-1">
                          ...
                          <Textarea 
                              ...
                              value={item.message || ""}
                              onChange={(e) => handleDetailChange(product._id, 'message', e.target.value)}
                          />
                      </div>
                  </div>
