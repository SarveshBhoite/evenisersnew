    ...
    <div className="min-h-screen bg-pink text-zinc-900">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {loading ? (
              [1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="aspect-[3/4] bg-zinc-100 rounded-3xl animate-pulse"
                />
              ))
            ) : (
              featuredEvents.map((event: any) => (
                <Link key={event._id} href={`/product/${event._id}`} className="group">
                  ...
                  <h3 className="font-serif text-xl font-bold group-hover:text-zinc-600 transition-colors">
                    {event.name}
                  </h3>
      ...
      <section className="bg-black py-20 px-6 mx-6 rounded-[3rem] my-24 text-white text-center">
        ...
        <p className="text-zinc-400 mb-10 max-w-xl mx-auto">
          Our 2025-26 wedding slots are filling up fast. Contact our lead designers
          to secure your date today.
        </p>
        <Button
          asChild
          size="lg"
          className="rounded-full bg-white text-black hover:bg-zinc-200 px-10"
        >
          ...
          {[
            {
              ...
              role: "Bride",
              quote:
                "The floral mandap they designed was beyond my dreams. Truly the best decorators in town.",
            },
            {
              name: "Rajesh Mehra",
              role: "Corporate HR",
              quote:
                "Exceptional coordination for our annual gala. Professional, timely, and creative.",
            },
            {
              name: "Sneha Kapoor",
              role: "Mother",
              quote:
                "The birthday theme for my son's first year was so magical. Every detail was perfect.",
            },
          ].map((t, i) => (
