            ...
            <div className="backdrop-blur-xl bg-white/85 rounded-full border border-white/60 shadow-xl px-6 py-3 relative">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2.5 shrink-0">
                        <Link href="/" className="font-serif text-xl md:text-2xl font-bold text-foreground tracking-tight whitespace-nowrap">
                            Evenizers
                        </Link>
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger className="outline-none">
                                    <div
                                        ...
                                        className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 cursor-pointer px-2 py-1.5 rounded-md bg-zinc-100/50 text-zinc-500 hover:text-black border border-transparent hover:border-zinc-200"
                                    >
