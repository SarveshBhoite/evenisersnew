                            ...
                            {activeTab === "signin" && (
                                <div className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => {
                                            // Trigger your existing GoogleAuthButton logic
                                            const googleBtn = document.getElementById('hidden-google-btn');
                                            if (googleBtn) googleBtn.click();
                                        }}
                                        className="w-full h-13 md:h-14 bg-white border-2 border-zinc-200 hover:border-[#D4AF37] hover:shadow-lg text-zinc-700 font-semibold text-sm flex items-center justify-center gap-3 transition-all duration-300 group"
                                    >
                                        <GoogleIcon />
                                        <span>Continue with Google</span>
                                        <ArrowRight className="w-4 h-4 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-[#D4AF37]" />
                                    </button>

                                    {/* Hidden actual Google button */}
                                    <div className="hidden">
                                        <div id="hidden-google-btn">
                            ...
                            {activeTab === "signup" && signUpStep === 1 && (
                                <div className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => {
                                            const googleBtn = document.getElementById('hidden-google-btn-signup');
                                            if (googleBtn) googleBtn.click();
                                        }}
                                        className="w-full h-13 md:h-14 bg-white border-2 border-zinc-200 hover:border-[#D4AF37] hover:shadow-lg text-zinc-700 font-semibold text-sm flex items-center justify-center gap-3 transition-all duration-300 group"
                                    >
                                    ...
                                    <div className="hidden">
                                        <div id="hidden-google-btn-signup">
                                            <GoogleAuthButton isSilent={true} onSuccess={onAuthSuccess} />
                                        </div>
                                    </div>
